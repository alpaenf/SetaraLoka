...
export default function CompanyJobCreate() {
  ...
  const submit = (e) => {
    ...
    const sanReqs = reqs.filter(r => r.trim() !== '');
    const sanBens = bens.filter(b => b.trim() !== '');
    const payload2 = { ...data, requirements: sanReqs, benefits: sanBens };
    router.post(route('company.jobs.store'), payload2);
  };
  ...
  return (
    <CompanyShell>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Buat Lowongan</h1>
          <p className="text-sm text-gray-600">Isi detail lowongan yang inklusif dan jelas.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex items-center gap-2">
            ...
            <label htmlFor="publish" className="text-sm text-gray-700">Publikasikan segera</label>
        </div>
        <div>
