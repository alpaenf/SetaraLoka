...
export default function Edit({ auth, resume }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('resumes.update', resume.slug));
    };
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex items-center justify-center flex-1 gap-2 px-4 py-3 text-sm font-medium text-white transition-all duration-300 bg-gradient-to-r from-amber-600 to-amber-700 rounded-lg hover:from-amber-700 hover:to-amber-800 hover:shadow-lg disabled:opacity-50"
                            >
                                <Save className="w-4 h-4" />
                                {processing ? 'Menyimpan...' : 'Update Resume'}
                            </button>
                        </div>
                    </form>
                </div>
